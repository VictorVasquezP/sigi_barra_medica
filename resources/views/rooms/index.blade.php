                                    ...
                                    <tr>
                                        ...
                                        <td class="no-sort no-click bread-actions">
                                            @foreach($actions as $action)
                                                ...
                                                @endif
                                            @endforeach
                                            <a href="javascript:;" title="" class="btn btn-sm btn-dark pull-right status" data-id="{{$data->getKey()}}" id="status-{{$data->getKey()}}" style="margin-right: 5px" >
                                                <i class="voyager-check-circle"></i>
                                                <span class="hidden-xs hidden-sm">Cambiar estatus</span>
                                            </a> 
                                        </td>
                                    </tr>
                                    @endforeach
    ...
    <div class="modal modal-primary fade" tabindex="-1" id="status_modal" role="dialog">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="{{ __('voyager::generic.close') }}"><span aria-hidden="true">&times;</span></button>
                    <h4 class="modal-title"><i class="voyager-check-circle"></i> ¿Está seguro de el estatus de la habitación?</h4>
                </div>
                <div class="modal-footer">
                    <form action="#" id="status_form" method="POST">
                        ...
                        <div class="form-group" style="display: flex;">
                            ...
                            <label class="control-label" for="status_id">Estatus: </label>
...
@section('javascript')
    ...
    <script>
        ...
        $('td').on('click', '.status', function (e) {
            $('#status_form')[0].action = '{{ route('rooms.updateStatus', '__id') }}'.replace('__id', $(this).data('id'));
